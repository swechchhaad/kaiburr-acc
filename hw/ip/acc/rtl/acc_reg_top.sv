...
module acc_reg_top (
  ...
  // To HW
  output acc_reg_pkg::acc_reg2hw_t reg2hw, // Write
  input  acc_reg_pkg::acc_hw2reg_t hw2reg, // Read
  ...
  logic err_bits_kmac_recov_error_qs;
  logic err_bits_kmac_recov_error_wd;
  ...
  logic err_bits_kmac_fatal_error_qs;
  logic err_bits_kmac_fatal_error_wd;
  ...
  logic fatal_alert_cause_kmac_fatal_error_qs;
  logic insn_cnt_re;
  logic insn_cnt_we;
  ...
  //   F[kmac_recov_error]: 8:8
  prim_subreg_ext #(
    .DW    (1)
  ) u_err_bits_kmac_recov_error (
    .re     (err_bits_re),
    .we     (err_bits_we),
    .wd     (err_bits_kmac_recov_error_wd),
    .d      (hw2reg.err_bits.kmac_recov_error.d),
    .qre    (),
    .qe     (err_bits_flds_we[8]),
    .q      (reg2hw.err_bits.kmac_recov_error.q),
    .ds     (),
    .qs     (err_bits_kmac_recov_error_qs)
  );
  assign reg2hw.err_bits.kmac_recov_error.qe = err_bits_qe;
  ...
  //   F[kmac_fatal_error]: 24:24
  prim_subreg_ext #(
    .DW    (1)
  ) u_err_bits_kmac_fatal_error (
    .re     (err_bits_re),
    .we     (err_bits_we),
    .wd     (err_bits_kmac_fatal_error_wd),
    .d      (hw2reg.err_bits.kmac_fatal_error.d),
    .qre    (),
    .qe     (err_bits_flds_we[17]),
    .q      (reg2hw.err_bits.kmac_fatal_error.q),
    .ds     (),
    .qs     (err_bits_kmac_fatal_error_qs)
  );
  assign reg2hw.err_bits.kmac_fatal_error.qe = err_bits_qe;
  ...
  //   F[kmac_fatal_error]: 8:8
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRO),
    .RESVAL  (1'h0),
    .Mubi    (1'b0)
  ) u_fatal_alert_cause_kmac_fatal_error (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),
    ...
    // from internal hardware
    .de     (hw2reg.fatal_alert_cause.kmac_fatal_error.de),
    .d      (hw2reg.fatal_alert_cause.kmac_fatal_error.d),
    ...
    // to register interface (read)
    .qs     (fatal_alert_cause_kmac_fatal_error_qs)
  );
  ...
  logic [10:0] addr_hit;
  always_comb begin
    addr_hit[ 0] = (reg_addr == ACC_INTR_STATE_OFFSET);
    addr_hit[ 1] = (reg_addr == ACC_INTR_ENABLE_OFFSET);
    addr_hit[ 2] = (reg_addr == ACC_INTR_TEST_OFFSET);
    addr_hit[ 3] = (reg_addr == ACC_ALERT_TEST_OFFSET);
    addr_hit[ 4] = (reg_addr == ACC_CMD_OFFSET);
    addr_hit[ 5] = (reg_addr == ACC_CTRL_OFFSET);
    addr_hit[ 6] = (reg_addr == ACC_STATUS_OFFSET);
    addr_hit[ 7] = (reg_addr == ACC_ERR_BITS_OFFSET);
    addr_hit[ 8] = (reg_addr == ACC_FATAL_ALERT_CAUSE_OFFSET);
    addr_hit[ 9] = (reg_addr == ACC_INSN_CNT_OFFSET);
    addr_hit[10] = (reg_addr == ACC_LOAD_CHECKSUM_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(ACC_PERMIT[ 0] & ~reg_be))) |
               (addr_hit[ 1] & (|(ACC_PERMIT[ 1] & ~reg_be))) |
               (addr_hit[ 2] & (|(ACC_PERMIT[ 2] & ~reg_be))) |
               (addr_hit[ 3] & (|(ACC_PERMIT[ 3] & ~reg_be))) |
               (addr_hit[ 4] & (|(ACC_PERMIT[ 4] & ~reg_be))) |
               (addr_hit[ 5] & (|(ACC_PERMIT[ 5] & ~reg_be))) |
               (addr_hit[ 6] & (|(ACC_PERMIT[ 6] & ~reg_be))) |
               (addr_hit[ 7] & (|(ACC_PERMIT[ 7] & ~reg_be))) |
               (addr_hit[ 8] & (|(ACC_PERMIT[ 8] & ~reg_be))) |
               (addr_hit[ 9] & (|(ACC_PERMIT[ 9] & ~reg_be))) |
               (addr_hit[10] & (|(ACC_PERMIT[10] & ~reg_be)))));
  end
  ...
  assign err_bits_kmac_recov_error_wd = reg_wdata[8];
  ...
  assign err_bits_kmac_fatal_error_wd = reg_wdata[24];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[7]: begin
        ...
        reg_rdata_next[8] = err_bits_kmac_recov_error_qs;
        ...
        reg_rdata_next[24] = err_bits_kmac_fatal_error_qs;
      end
      ...
      addr_hit[8]: begin
        ...
        reg_rdata_next[8] = fatal_alert_cause_kmac_fatal_error_qs;
      end
