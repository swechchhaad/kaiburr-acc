...
ACC stands for Assymetrical Cryptographic Co-processor, and this document describes how to write and build software for it.
The [ACC reference manual](../../../hw/ip/otbn/README.md) describes the hardware and associated ISA.
...
The ACC ISA and programmer model are described in the [ACC reference manual](../../../hw/ip/otbn/README.md).
...
For specific formatting and secure coding guidelines, see the [ACC style guide](../style_guides/otbn_style_guide.md).

## The tools

### Assembler

The ACC assembler is called `otbn_as.py` and can be found at `hw/ip/otbn/util/otbn_as.py`.
...
The ACC linker is called `otbn_ld.py` and can be found at `hw/ip/otbn/util/otbn_ld.py`.
...
To disassemble ACC code, use `otbn_objdump.py`, which can be found at `hw/ip/otbn/util/otbn_objdump.py`.
